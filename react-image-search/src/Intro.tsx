...
const Intro = () => {
    return (
        <div className="intro">
            ...
            <p>The purpose of this project is to create an image search SPA using different frontend frameworks to compare them. Here are links to each of my projects:</p>
            <ol>
